...
mp3_url = r'E:\speechRoom\voice_du\voice_ss.mp3'
...
def baidu_api(answer):
    ...
    global mp3_url
    mp3_url = r'E:\speechRoom\voices\voice_tts' + str(iname) + '.mp3'
...
def baidu_api2(answer):
    ...
    global mp3_url
    mp3_url = r'E:\speechRoom\voice_du\voice_tsn' + str(name) + '.mp3'
